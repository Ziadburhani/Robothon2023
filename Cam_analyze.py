...
if detected_circles is not None:
    ...
    for pt in sorted_circles:
      ...
      # Draw the circumference of the circle.
        ...
        cv2.putText(img, "(" + str(-350-wx) + ","+ str(350-wy) + ")", (a-r-80,b+r-50), cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,0,255),1 )
        print(str(a) + "\t\t"+ str(b) + "\t\t" + str(wx) + "\t\t" + str(wy) )
    ...
    cv2.putText(img, "Rotation angle "+ str(rot) +" degree", (10,20), cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,255),1 )
    ...
    for p in range(0,12):
        ...
        gradX = 3.3378
        gradY = 3.325
        calc_wx = round(-350 - (new_y - origin_y)/gradX,2) # Y robot is x pixel
        calc_wy = round(350 - (new_x - origin_x)/gradY,2) # X robot is y pixel
        ...
        cv2.putText(img, "[" + str(new_x) + ","+ str(new_y) + "]", (new_x - 40, new_y - 10), cv2.FONT_HERSHEY_SIMPLEX,0.7,(255,0,0),1 )
        cv2.putText(img, "(" + str(calc_wx) + ","+ str(calc_wy) + ")", (c_px - 100, c_py + 20), cv2.FONT_HERSHEY_SIMPLEX,0.7,(0,255,240),1 )
